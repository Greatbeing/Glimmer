...
// 音乐音调映射
const MUSIC_TONES = {
  '#希望': [523.25, 659.25, 783.99], '#勇气': [493.88, 622.25, 739.99],
  '#自我': [440.00, 554.37, 659.25], '#英雄主义': [392.00, 493.88, 587.33],
  '#童心': [523.25, 587.33, 698.46], '#生命': [440.00, 523.25, 659.25],
  '#连接': [523.25, 659.25, 783.99], '#行动': [587.33, 659.25, 783.99],
  '#反思': [392.00, 440.00, 523.25], '#变化': [440.00, 554.37, 659.25],
  '#智慧': [523.25, 659.25, 783.99], '#自由': [493.88, 622.25, 739.99],
  '#思想': [392.00, 493.88, 587.33], '#不完美': [440.00, 523.25, 659.25],
  '#接纳': [392.00, 440.00, 523.25], '#情绪': [523.25, 587.33, 698.46],
  '#安全感': [440.00, 554.37, 659.25], '#自我接纳': [392.00, 440.00, 523.25],
  '#幸福悖论': [523.25, 659.25, 783.99], '#选择': [493.88, 622.25, 739.99],
  '#自信': [440.00, 554.37, 659.25], '#成长': [587.33, 659.25, 783.99],
  '#控制': [392.00, 493.88, 587.33], '#系统思维': [440.00, 523.25, 659.25],
  '#耐心': [392.00, 440.00, 523.25], '#激情': [523.25, 659.25, 783.99],
  '#认知': [493.88, 622.25, 739.99], default: [523.25, 659.25, 783.99]
};
